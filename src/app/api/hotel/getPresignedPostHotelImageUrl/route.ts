...
export const GET = ensureLoggedIn(async (req: NextRequest) => {
  ...
  try {
    ...
    // Remove /object/ from the final URL as it's only needed for upload
    const finalImageUrl = `${env.NEXT_PUBLIC_MINIO_ENDPOINT}/${env.NEXT_PUBLIC_MINIO_BUCKET_HOTEL_IMAGES}/${imageId}.webp`;
